...
type ButtonProps = {
  ...
  variant?: 'primary' |          // Default dark gradient style
...
const variantClasses = {
  ...
  primary: 'dark-gradient text-light rounded-lg border border-neutral-700 bg-neutral-900',
  secondary: 'light-gradient border border-neutral-300 rounded-lg bg-neutral-300',
